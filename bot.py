...
জয়েন করার পরে সাথে সাথে ভিডিও পাবেন! 🎉""",
...
def settings_keyboard():
    ...
    keyboard = [
        ...
        [InlineKeyboardButton("🎬 Welcome Media", callback_data="setting_welcome_media")],  # NEW
        [InlineKeyboardButton("🔙 Back", callback_data="admin_main")]
    ]
    return InlineKeyboardMarkup(keyboard)
...
Select an option below:"""
        ...
        welcome_media = get_setting('welcome_media_enabled', False)  # NEW
        ...
        welcome_media_status = "✅ ON" if welcome_media else "❌ OFF"  # NEW
...
async def channel_post(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    try:
        ...
        # Create admin notification with BETTER copy functionality
        deep_link = f"https://t.me/{bot_username}?start={message_id}"
        
        # Send TWO messages: one with info, one with just the copyable ID
        info_text = f"""{media_icon} **New {media_type.title()} Uploaded!**
